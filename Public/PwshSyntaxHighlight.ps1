...
function Write-Codeblock {
    ...
    $SyntaxTheme = Get-SyntaxHighlightTheme -Theme $Theme
    $ForegroundRgb = $SyntaxTheme.ForegroundRgb
    $BackgroundRgb = $SyntaxTheme.BackgroundRgb
...
function Get-TokenColor {
    ...
    $ForegroundRgb = switch -wildcard ($Kind) {
        "Function" { $script:SyntaxHighlightingThemes[$Theme].Function }
        "Generic" { $script:SyntaxHighlightingThemes[$Theme].Generic }
        "*String*" { $script:SyntaxHighlightingThemes[$Theme].String }
        "Variable" { $script:SyntaxHighlightingThemes[$Theme].Variable }
        "Identifier" { $script:SyntaxHighlightingThemes[$Theme].Identifier }
        "Number" { $script:SyntaxHighlightingThemes[$Theme].Number }
        default { $script:SyntaxHighlightingThemes[$Theme].Default }
    }
    if($TokenFlags -like "*operator*" -or $TokenFlags -like "*keyword*") {
        $ForegroundRgb = $script:SyntaxHighlightingThemes[$Theme].Keyword
    }
...
function Write-Token {
    ...
    $ForegroundRgb = $script:SyntaxHighlightingThemes[$Theme].ForegroundRgb
    $BackgroundRgb = $script:SyntaxHighlightingThemes[$Theme].BackgroundRgb

    if($Highlight) {
        $ForegroundRgb = $script:SyntaxHighlightingThemes[$Theme].HighlightRgb
    }
